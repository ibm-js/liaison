...
```bash
$ git clone git@github.com:username/liaison.git
```

This will clone your fork to your current path in a directory named `liaison`.
...
```bash
$ cd liaison
$ git remote add upstream git@github.com:ibm-dojo/liaison.git
$ git fetch upstream
```
